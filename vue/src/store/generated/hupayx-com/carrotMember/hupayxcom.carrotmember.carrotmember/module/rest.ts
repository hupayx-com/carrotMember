...
export interface CarrotmemberMember {
  creator?: string;
...
export type CarrotmemberMsgSendRewardResponse = object;

/**
 * Params defines the parameters for the module.
 */
export type CarrotmemberParams = object;

export interface CarrotmemberQueryMembersResponse {
  Member?: CarrotmemberMember[];
 ...
 */
export interface CarrotmemberQueryParamsResponse {
...
/**
 * @title carrotmember/genesis.proto
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryMembers = (
    ...
    this.request<CarrotmemberQueryMembersResponse, RpcStatus>({
  ...
  queryParams = (params: RequestParams = {}) =>
    this.request<CarrotmemberQueryParamsResponse, RpcStatus>({
      path: `/hupayxcom/carrotmember/carrotmember/params`,
      method: "GET",
      format: "json",
      ...params,
    });
